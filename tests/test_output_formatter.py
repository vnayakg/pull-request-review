    ...
    issues = [
        {
            ...
            "issue_header": "Test",
            "issue_content": "Content 1 with more text",
            "start_line": 1,
            "end_line": 2,
        },
        {
        ...
        },  # Duplicate
        {
            "relevant_file": "test.py",
            "issue_header": "Test 2",
            "issue_content": "Content 2 with more text",
            "start_line": 3,
            "end_line": 4,
        },
    ]
        ...
        "key_issues_to_review": [
            {
                "relevant_file": "test.py",
                "issue_header": "Test",
                "issue_content": "Content with sufficient length",
                "start_line": 1,
                "end_line": 2,
            }
        ],
...
def test_format_markdown():
    review = {
        ...
        "technical_analysis": {"code_quality": "Good", "security_considerations": "None"},
        "architectural_consistency": {"pattern_alignment": "Well aligned"},
        "overall_assessment": {
