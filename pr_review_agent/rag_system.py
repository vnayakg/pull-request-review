...
class RAGSystem:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.embedder = RAGEmbedder(
            model_name=self.rag_config.get("embedder", {}).get(
        ...
        self.retriever = RAGRetriever(
            ...
            similarity_threshold=self.rag_config.get("retriever", {}).get(
                "similarity_threshold", 0.7
            ),
        )

        self.repository_processor = RAGRepositoryProcessor(self.rag_config.get("text_splitter", {}))
    ...
    def get_context_for_diff(self, diff_content: str, repo_url: str, branch: str = "main") -> str:
        ...
        relevant_files = self.repository_processor.get_relevant_files_for_diff(
